...
SPI_PinConfig_t Global_SPI_pinConfig1;
SPI_PinConfig_t Global_SPI_pinConfig2;
...
void SPI_init(SPI_PinConfig_t *SPI_pinConfig, SPI_Registers_t *SPIx) {
	...
	/*            		Enable SPI clocks  					    */
	if (SPIx == SPI1) {
		Global_SPI_pinConfig1 = *SPI_pinConfig;
		Global_SPI_pinConfig[SPI1_Index] = &Global_SPI_pinConfig1;
		RCC_SPI1_CLK_EN();
	} else if (SPIx == SPI2) {
		Global_SPI_pinConfig2 = *SPI_pinConfig;
		Global_SPI_pinConfig[SPI2_Index] = &Global_SPI_pinConfig2;
		RCC_SPI2_CLK_EN();
	}
